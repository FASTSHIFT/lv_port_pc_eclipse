 ...
 */
#define LV_USE_DRAW_NANOVG (LV_USE_NANOVG && LV_USE_OPENGLES)
...
#define LV_USE_VG_LITE_THORVG  LV_USE_DRAW_VG_LITE
    ...
    #define LV_VG_LITE_THORVG_BUF_ADDR_ALIGN 16
