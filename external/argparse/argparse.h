...
/**
 * argparse help callback
 * @param self argparse object
...
/**
 * argparse help callback without exit
 * @param self argparse object
 * @param option option object
 * @return 0 on success, 1 on failure
 */
...
#define ARGPARSE_EXIT_SUCCESS 0
#define ARGPARSE_EXIT_FAILURE 1
...
#define OPT_HEX(...) { ARGPARSE_OPT_HEX, __VA_ARGS__ }
 ...
 * @param flags argparse flags
 * @return 0 on succes, otherwise on failure
 */
int argparse_init(struct argparse* self, struct argparse_option* options, const char* const* usages, int flags);

/**
 * Set description and epilog for argparse object
 * @param self argparse object
 * @param description a description after usage
 * @param epilog a description at the end
 */
